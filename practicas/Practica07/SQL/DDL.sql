...
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderJuguete_fkey2 ON VenderJuguete IS 'La llave foránea de la tabla VenderJuguete
que hace referencia al id de la clinica a la que pertenece la Caja';
ALTER TABLE VenderJuguete ADD CONSTRAINT venderJuguete_fkey3 FOREIGN KEY(idCaja)
REFERENCES Caja(idCaja);
COMMENT ON CONSTRAINT venderJuguete_fkey3 ON VenderJuguete IS 'La llave foránea de la tabla VenderJuguete
que hace referencia al id de la caja';
...
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderAccesorio_fkey2 ON VenderAccesorio IS 'La llave foránea de la tabla VenderAccesorio
que hace referencia al id de la clinica a la que pertenece la Caja';
ALTER TABLE VenderAccesorio ADD CONSTRAINT venderAccesorio_fkey3 FOREIGN KEY(idCaja)
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderAccesorio_fkey3 ON venderAccesorio IS 'La llave foránea de la tabla VenderAccesorio
que hace referencia al id de la caja';
...
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderMedicamento_fkey2 ON venderMedicamento IS 'La llave foránea de la tabla VenderMedicamento
que hace referencia al id de la clinica a la que pertenece la Caja';
ALTER TABLE VenderMedicamento ADD CONSTRAINT venderMedicamento_fkey3 FOREIGN KEY(idCaja)
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderMedicamento_fkey3 ON VenderMedicamento IS 'La llave foránea de la tabla VenderMedicamento
que hace referencia al id de la caja';
...
que hace referencia al id de la comida';
ALTER TABLE VenderComida ADD CONSTRAINT venderComida_fkey2 FOREIGN KEY(idClinica)
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderComida_fkey2 ON VenderComida IS 'La llave foránea de la tabla VenderComida
que hace referencia al id de la clinica a la que pertenece la Caja';
ALTER TABLE VenderComida ADD CONSTRAINT venderComida_fkey3 FOREIGN KEY(idCaja)
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT venderComida_fkey3 ON VenderComida IS 'La llave foránea de la tabla VenderComida
que hace referencia al id de la caja';
...
REFERENCES Normal(idConsulta) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboNormal_fkey2 ON GenerarReciboNormal IS 'La llave foránea de la tabla GenerarReciboNormal
que hace referencia al id de la consulta';
ALTER TABLE GenerarReciboNormal ADD CONSTRAINT generarReciboNormal_fkey3 FOREIGN KEY(idMascota)
REFERENCES Normal(idMascota) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboNormal_fkey3 ON GenerarReciboNormal IS 'La llave foránea de la tabla GenerarReciboNormal
que hace referencia al id de la mascota que va a una consulta normal';
...
REFERENCES Emergencia(idConsulta) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboEmergencia_fkey2 ON GenerarReciboEmergencia IS 'La llave foránea de la tabla GenerarReciboEmergencia
que hace referencia al id de la consulta';
ALTER TABLE GenerarReciboEmergencia ADD CONSTRAINT generarReciboEmergencia_fkey3 FOREIGN KEY(idMascota)
REFERENCES Emergencia(idMascota) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboEmergencia_fkey3 ON GenerarReciboEmergencia IS 'La llave foránea de la tabla GenerarReciboEmergencia
que hace referencia al id de la mascota que va a una consulta de emergencia';
...
REFERENCES Tratamiento(idConsulta) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboTratamiento_fkey2 ON GenerarReciboTratamiento IS 'La llave foránea de la tabla GenerarReciboTratamiento
que hace referencia al id de la consulta';
ALTER TABLE GenerarReciboTratamiento ADD CONSTRAINT generarReciboTratamiento_fkey3 FOREIGN KEY(idMascota)
REFERENCES Tratamiento(idMascota) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT generarReciboTratamiento_fkey3 ON GenerarReciboTratamiento IS 'La llave foránea de la tabla GenerarReciboTratamiento
que hace referencia al id de la mascota que va a una consulta de tratamiento estético';
...
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT clienteNormal_fkey1 ON ClienteNormal IS 'La llave foránea de la tabla ClienteNormal que hace referencia al
id de la caja';
ALTER TABLE ClienteNormal ADD CONSTRAINT clienteNormal_fkey2 FOREIGN KEY(idClinica)
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT clienteNormal_fkey2 ON ClienteNormal IS 'La llave foránea de la tabla ClienteNormal que hace referencia al 
id de la clinica a la que pertenece la Caja';
...
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT clienteFrecuente_fkey1 ON ClienteFrecuente IS 'La llave foránea de la tabla ClienteFrecuente que hace
referencia al id de la caja';
ALTER TABLE ClienteFrecuente ADD CONSTRAINT clienteFrecuente_fkey2 FOREIGN KEY(idClinica)
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT clienteFrecuente_fkey2 ON ClienteFrecuente IS 'La llave foránea de la tabla ClienteFrecuente que hace
referencia al id de la clinica a la que pertenece la Caja';
...
REFERENCES Caja(idCaja) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT recibo_fkey1 ON Recibo IS 'La llave foránea de la tabla Recibo que 
hace referencia al id de la caja';
ALTER TABLE Recibo ADD CONSTRAINT recibo_fkey2 FOREIGN KEY(idClinica)
REFERENCES Caja(idClinica) ON UPDATE CASCADE ON DELETE CASCADE;
COMMENT ON CONSTRAINT recibo_fkey2 ON recibo IS 'La llave foranea de la tabla Recibo que 
hace referencia al id de la clinica a la que pertenece la Caja';
